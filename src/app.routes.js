...
const options = {
  options: (site) => ({
    ...
    headerLeft: () => (
      <Icon
        name="times"
        style={{color: '#179D82', marginLeft: 10}}
        size={22}
...
function HomeStack(props) {
  return (
    <Stack.Navigator screenOptions={screenOptions}>
      <Stack.Screen name="Anasayfa" component={Home} options={homeOptions} />
      ...
      <Stack.Screen
        name="n11.com"
        component={FilterPageN11}
        options={options.options('N11')}
      />
      <Stack.Screen
        name="trendyol.com"
        component={FilterPageTD}
        options={options.options('Trendyol')}
      />
      <Stack.Screen
        name="hepsiburada.com"
        component={FilterPageHB}
        options={options.options('HepsiBurada')}
      />
      <Stack.Screen
        name="gittigidiyor.com"
        component={FilterPageGG}
        options={options.options('GittiGidiyor')}
      />
      <Stack.Screen
        name="amazon.com"
        component={FilterPageAMZ}
        options={options.options('Amazon')}
      />
...
const KeywordStack = (props) => {
  return (
    <Stack.Navigator screenOptions={screenOptions}>
      ...
      <Stack.Screen
        name="Kelime Araştırma Detay"
        component={KeywordSearchDetail}
      />
      <Stack.Screen name="Trendyol" component={SearchTD} />
      <Stack.Screen name="HepsiBurada" component={SearchHB} />
      <Stack.Screen name="N11" component={SearchN11} />
      ...
      <Tab.Screen
        options={{
          ...
          tabBarIcon: ({color}) => (
            <AnimationSearch
              gg={() => {
                props.navigation.navigate('GittiGidiyor');
              }}
              td={() => {
                props.navigation.navigate('Trendyol');
              }}
              n11={() => {
                props.navigation.navigate('N11');
              }}
              hb={() => {
                props.navigation.navigate('HepsiBurada');
              }}
              amz={() => {
                props.navigation.navigate('Amazon');
              }}
            />
          ),
        }}
