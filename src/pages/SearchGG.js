...
const SearchGG = ({route, navigation}) => {
  ...
  function getSearchData() {
    ...
    AsyncStorage.multiGet(['@userName', '@userToken']).then((response) => {
      ...
      // console.log('ROWDATA2', rowData[rowData.length - 1]);
    });
  }
      ...
      <>
        {route.params != null ? (
          <View
            ...
            {offset >= 200 || search.recordsTotal <= offset + 10 ? (
              <View></View>
            ) : (
              <TouchableOpacity
                activeOpacity={0.9}
            ...
            <Modal
              ...
              <View style={styles.modalContainer}>
                ...
                <TouchableOpacity
                  ...
                  style={{padding: 5}}>
                  <Text style={styles.text}>Günlük Satış'a göre artan</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                    sortSaleDesc();
                  ...
                  style={{padding: 5}}>
                  <Text style={styles.text}>Günlük Satış'a göre azalan</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                    sortRevenueAsc();
                  ...
                  style={{padding: 5}}>
                  <Text style={styles.text}>Ciroya göre artan</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                    sortRevenueDesc();
                  ...
                  style={{padding: 5}}>
                  <Text style={styles.text}>Ciroya göre azalan</Text>
                </TouchableOpacity>
              </View>
            </Modal>
            <View
              ...
              <View>
                <Button
                  ...
                  name={'filter'}
                  onClicked={() =>
                    navigation.navigate('gittigidiyor.com', {
                      Keywords: keywords,
                      MinPrice: minPrice,
                      MaxPrice: maxPrice,
                      MinSale: minSale,
